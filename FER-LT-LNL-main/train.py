...
data = get_variables(train_number=200)
...
def warm_up(net, optimizer, scaler, dataloader):
    net.train()
...
def eval(epoch, model, eval_loader):
    ...
    plotter.plot_loss_num(loss_plot, epoch, 8)
    ...
    plotter.plot_prob_num(prob_plot, epoch, 8)
    return prob
...
for epoch in range(num_epochs + 1):
    ...
    #     print('Warmup Net1')
    #     warm_up(net1, optimizer1, scaler1, train_loader)
    #     train_loader = loader.run('warm_up')
    #     print('\nWarmup Net2')
    #     warm_up(net2, optimizer2, scaler2, train_loader)
    # else:
    ...
    # prob1 = eval(epoch, net1, eval_loader)
    # print('\n==== net 2 evaluate next epoch training data loss ====')
    # eval_loader = loader.run('eval')
    # prob2 = eval(epoch, net2, eval_loader)
